...
![es-write](D:\Codes\ZPTutorial\images\snap\es-write.png)
...
![es-write-detail](D:\Codes\ZPTutorial\images\snap\es-write-detail.png)
...
> 安装、配置、命令可以参考：[ElasticSearch 运维](elastic-elasticsearch-ops.md)
