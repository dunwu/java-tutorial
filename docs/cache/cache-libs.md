...
- [一、ConcurrentHashMap](#一concurrenthashmap)
- [二、LRUHashMap](#二lruhashmap)
- [三、Guava Cache](#三guava-cache)
  - [Guava Cache 缓存回收](#guava-cache-缓存回收)
  - [基于容量回收](#基于容量回收)
  - [基于定时回收](#基于定时回收)
  - [基于引用回收](#基于引用回收)
  - [Guava Cache 核心 API](#guava-cache-核心-api)
- [四、Caffeine](#四caffeine)
- [五、Ehcache](#五ehcache)
- [六、进程内缓存对比](#六进程内缓存对比)
- [参考资料](#参考资料)
