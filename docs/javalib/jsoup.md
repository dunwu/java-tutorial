...
- [简介](#简介)
- [加载](#加载)
    - [从HTML字符串加载一个文档](#从html字符串加载一个文档)
    - [解析一个body片断](#解析一个body片断)
    - [从URL加载一个文档](#从url加载一个文档)
    - [从一个文件加载一个文档](#从一个文件加载一个文档)
- [解析](#解析)
    - [使用DOM方法来遍历一个文档](#使用dom方法来遍历一个文档)
    - [使用选择器语法来查找元素](#使用选择器语法来查找元素)
    - [从元素抽取属性，文本和HTML](#从元素抽取属性文本和html)
    - [处理URLs](#处理urls)
- [数据修改](#数据修改)
    - [设置属性的值](#设置属性的值)
    - [设置一个元素的HTML内容](#设置一个元素的html内容)
    - [设置元素的文本内容](#设置元素的文本内容)
- [HTML清理](#html清理)
    - [消除不受信任的HTML (来防止XSS攻击)](#消除不受信任的html-来防止xss攻击)
- [参考](#参考)
