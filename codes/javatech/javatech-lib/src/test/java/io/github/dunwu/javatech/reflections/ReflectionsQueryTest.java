...
public class ReflectionsQueryTest implements NameHelper {
		...
		reflections = new Reflections(
			new ConfigurationBuilder()
				...
				.filterInputsBy(new FilterBuilder()
					.includePattern("io\\.github\\.dunwu\\.javatech\\.reflections\\.TestModel\\$.*")
					.or(s -> s.endsWith(".xml")))
	...
	public void testGetAll() {
		reflections = new Reflections(
			new ConfigurationBuilder()
				.forPackage("io.github.dunwu.javatech.reflections")
				.filterInputsBy(new FilterBuilder().includePattern("io\\.github\\.dunwu\\.javatech\\.reflections\\.TestModel\\$.*"))
		...
		assertThat("all (sub) types",
			...
			equalTo("java.lang.Object", "java.lang.annotation.Annotation",
				"io.github.dunwu.javatech.reflections.TestModel$MAI1", "io.github.dunwu.javatech.reflections.TestModel$AI1", "io.github.dunwu.javatech.reflections.TestModel$AI2",
				"io.github.dunwu.javatech.reflections.TestModel$I1", "io.github.dunwu.javatech.reflections.TestModel$I2", "io.github.dunwu.javatech.reflections.TestModel$I3",
				"io.github.dunwu.javatech.reflections.TestModel$AF1", "io.github.dunwu.javatech.reflections.TestModel$AM1", "io.github.dunwu.javatech.reflections.TestModel$AM2",
				"io.github.dunwu.javatech.reflections.TestModel$AC1", "io.github.dunwu.javatech.reflections.TestModel$AC1n", "io.github.dunwu.javatech.reflections.TestModel$AC2", "io.github.dunwu.javatech.reflections.TestModel$AC3",
				"io.github.dunwu.javatech.reflections.TestModel$C1", "io.github.dunwu.javatech.reflections.TestModel$C2", "io.github.dunwu.javatech.reflections.TestModel$C3", "io.github.dunwu.javatech.reflections.TestModel$C4",
				"io.github.dunwu.javatech.reflections.TestModel$C5", "io.github.dunwu.javatech.reflections.TestModel$C6", "io.github.dunwu.javatech.reflections.TestModel$C7"));
	}
